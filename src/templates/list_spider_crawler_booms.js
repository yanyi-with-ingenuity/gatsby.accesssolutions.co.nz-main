                ...
                <div className="entry__container">
                    ...
                    <div>
                        <table className="data__table" border="0" cellPadding="0" cellSpacing="0">
                            ...
                            <tbody>
                                {data.spider_booms_hybrid.edges
                ...
                <div className="entry__container">
                    ...
                    <div>
                        <table className="data__table" border="0" cellPadding="0" cellSpacing="0">
                            ...
                            <tbody>
                                {data.crawler_booms_diesel.edges
                                .sort((a, b) => parseFloat(a.node.frontmatter.spec.working_height) > parseFloat(b.node.frontmatter.spec.working_height) ? 1 : -1)
                                .map((entry, i) => (
                                <tr key={`data_` + i}>
                                    <td data-label="Name:&nbsp;"><Link to={entry.node.fields.slug}>{entry.node.frontmatter.heading}</Link></td>
...
export default SpiderCrawlerBooms;
...
export const query = graphql`
	query($slug: String!) {
        ...
        spider_booms_hybrid: allMarkdownRemark(filter: {frontmatter: {category: {eq: "spider_booms_hybrid"}}}) {
            edges {
                node {
                    frontmatter {
                        heading
        ...
        crawler_booms_diesel: allMarkdownRemark(filter: {frontmatter: {category: {eq: "crawler_booms_diesel"}}}) {
            edges {
                node {
                    frontmatter {
                        heading
        ...
        rail_booms_hybrid: allMarkdownRemark(filter: {frontmatter: {category: {eq: "rail_booms_hybrid"}}}) {
            edges {
                node {
                    frontmatter {
                        heading
