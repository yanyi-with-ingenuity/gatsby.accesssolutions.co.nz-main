    ...
    return (
        <div className="page">
            ...
            <div className="layout category_entry grey">
                <div className="entry__container">
                    <div className="list">
                        <h2>Knuckle Boom Lifts - Electric</h2>
                    </div>
                    <div>
                        <table className="data__table" border="0" cellPadding="0" cellSpacing="0">
                            <thead>
                            ...
                            <tbody>
                                {data.knuckle_boom_lifts_electric.edges
                                .sort((a, b) => parseFloat(a.node.frontmatter.spec.working_height) > parseFloat(b.node.frontmatter.spec.working_height) ? 1 : -1)
                                .map((entry, i) => (
                                <tr key={`data_` + i}>
                                    <td data-label="Name:&nbsp;"><Link to={entry.node.fields.slug}>{entry.node.frontmatter.heading}</Link></td>
            ...
            <div className="layout category_entry grey">
                <div className="entry__container">
                    <div className="list">
                        <h2>Knuckle Boom Lifts - Hybrid Boom</h2>
                    </div>
                    <div>
                        <table className="data__table" border="0" cellPadding="0" cellSpacing="0">
                            <thead>
                            ...
                            <tbody>
                                {data.knuckle_boom_lifts_hybrid_boom.edges
                                .sort((a, b) => parseFloat(a.node.frontmatter.spec.working_height) > parseFloat(b.node.frontmatter.spec.working_height) ? 1 : -1)
                                .map((entry, i) => (
                                <tr key={`data_` + i}>
                                    <td data-label="Name:&nbsp;"><Link to={entry.node.fields.slug}>{entry.node.frontmatter.heading}</Link></td>
            ...
            <div className="layout category_entry grey">
                <div className="entry__container">
                    <div className="list">
                        <h2>Knuckle Boom Lifts - Diesel</h2>
                    </div>
                    <div>
                        <table className="data__table" border="0" cellPadding="0" cellSpacing="0">
                            <thead>
                            ...
                            <tbody>
                                {data.knuckle_boom_lifts_diesel.edges
                                .sort((a, b) => parseFloat(a.node.frontmatter.spec.working_height) > parseFloat(b.node.frontmatter.spec.working_height) ? 1 : -1)
                                .map((entry, i) => (
                                <tr key={`data_` + i}>
                                    <td data-label="Name:&nbsp;"><Link to={entry.node.fields.slug}>{entry.node.frontmatter.heading}</Link></td>
            ...
            <div className="layout category_entry grey">
                <div className="entry__container">
                    <div className="list">
                        <h2>Telescopic Boom Lifts - Diesel</h2>
                    </div>
                    <div>
                        <table className="data__table" border="0" cellPadding="0" cellSpacing="0">
                            <thead>
                            ...
                            <tbody>
                                {data.telescopic_boom_lifts_diesel.edges
                                .sort((a, b) => parseFloat(a.node.frontmatter.spec.working_height) > parseFloat(b.node.frontmatter.spec.working_height) ? 1 : -1)
                                .map((entry, i) => (
                                <tr key={`data_` + i}>
                                    <td data-label="Name:&nbsp;"><Link to={entry.node.fields.slug}>{entry.node.frontmatter.heading}</Link></td>
...
export const query = graphql`
	query($slug: String!) {
        ...
        mastlifts_electric: allMarkdownRemark(filter: {frontmatter: {category: {eq: "mastlifts_electric"}}}) {
            edges {
                node {
                    frontmatter {
                        heading
        ...
        knuckle_boom_lifts_electric: allMarkdownRemark(filter: {frontmatter: {category: {eq: "knuckle_boom_lifts_electric"}}}) {
            edges {
                node {
                    frontmatter {
                        heading
        ...
        knuckle_boom_lifts_hybrid_boom: allMarkdownRemark(filter: {frontmatter: {category: {eq: "knuckle_boom_lifts_hybrid_boom"}}}) {
            edges {
                node {
                    frontmatter {
                        heading
        ...
        knuckle_boom_lifts_diesel: allMarkdownRemark(filter: {frontmatter: {category: {eq: "knuckle_boom_lifts_diesel"}}}) {
            edges {
                node {
                    frontmatter {
                        heading
        ...
        telescopic_boom_lifts_diesel: allMarkdownRemark(filter: {frontmatter: {category: {eq: "telescopic_boom_lifts_diesel"}}}) {
            edges {
                node {
                    frontmatter {
                        heading
